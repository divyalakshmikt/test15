...
export class FashionThreeComponent implements OnInit, OnDestroy {
  ...
  public sliders = [{
    ...
    subTitle: 'Caring beyond prescriptions',
    image: 'https://wellnessecommerce.s3.ap-south-1.amazonaws.com/banner3.jpg'
  }, {
    title: 'welcome to online pharmacy',
    subTitle: 'Where our family knows yours',
    image: 'https://wellnessecommerce.s3.ap-south-1.amazonaws.com/banner4.jpg'
  }];
